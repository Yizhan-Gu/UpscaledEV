...
Sessions_Table = pd.read_csv ('/Users/isabelmartinez/Downloads/ThesisCode/Data_2024/UCSD_AllSites_Sessions_wCarInfo_20210501_20240930.csv');

User_Data = pd.read_csv ('/Users/isabelmartinez/Downloads/ThesisCode/Scripts_2024/Driver_Table.csv');
...
Sessions_Table.loc[Sessions_Table['Car Battery'] == 'no data', 'Car Battery'] = float("nan") ## has nan
Sessions_Table['Car Battery'] = Sessions_Table['Car Battery'].astype("float");

Sessions_Table = Sessions_Table[~Sessions_Table['Car Battery'].isnull()]
Sessions_Table = Sessions_Table[Sessions_Table['Car Battery']>0]
...
for i in range(len(User_Data)):
    ...
    Sessions_Table_frequent.to_csv("Sessions_Data_"+str((User))+".csv", index=False); # export as csv
