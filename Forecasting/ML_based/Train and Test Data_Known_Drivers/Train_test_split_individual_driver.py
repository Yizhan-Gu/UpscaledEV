...
# -*- coding: utf-8 -*-
"""
Train Test split individual driver model store
...
User_Data=User_Data[User_Data['TotSession']>=20]
...
for i in range(len(User_Data)):
    ...
    train_df.to_csv("Train_Data_"+str(int(User))+".csv", index=False); # export as csv
    test_df.to_csv("Test_Data_"+str(int(User))+".csv", index=False); # export as csv