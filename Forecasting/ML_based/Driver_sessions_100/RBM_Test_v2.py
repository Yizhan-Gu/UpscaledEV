...
Sessions_Table = pd.read_csv ('C:/Users/Anne/Desktop/Total/Code/Avik/Past_Data/PF_UCSD_20210504_20230129_Sessions.csv');
...
for i in range(len(User_Data)):
    ...
    Data_User = pd.read_csv ('C:/Users/Anne/Desktop/Total/Code/Avik/Forecasting/ML_based/Driver_sessions_100/Driver_Sessions/Sessions_Data_'+str(int(User))+'.csv');
    Data_User['Session start'] = pd.to_datetime(Data_User['Session start']);

    #add section to select the sessions of This User BEFORE this current session
