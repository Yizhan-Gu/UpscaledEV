...
#Isabel's Version 2024 
#glob module used to call upon LMP file names 
# 'Car_' is a concation of User and Vehicle in as as string
#data_Merge_ThisDate_ThisCar clean-up for less than three rows to prevent the 
...
for month in np.array(range(1))+6:
    #month = 6
...
# =============================================================================
        ...
        D_all.to_csv(dir_Output, mode='a', index=False, header=True)
