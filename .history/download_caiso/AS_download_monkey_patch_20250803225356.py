...
# Import gridstatus first
import gridstatus
from gridstatus.caiso import CAISO

# Now import your local caiso to get the get_interval_as_prices method
sys.path.insert(0, os.path.dirname(os.path.abspath(__file__)))
import caiso

# Monkey patch the CAISO class to include your get_interval_as_prices method
CAISO.get_interval_as_prices = caiso.CAISO.get_interval_as_prices
