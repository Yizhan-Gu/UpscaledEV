...
def get_interval_as_prices(
    ...
    # Use the existing get_oasis_dataset method with custom dataset configuration
    # Since as_interval_clearing_prices is not in the current gridstatus, we'll use as_clearing_prices
    # but modify the parameters for RTM
